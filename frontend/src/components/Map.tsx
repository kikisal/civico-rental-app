            ...
            { (
              <button
                ...
                onClick={async () => {
                  ...
                  link.href = 'https://www.google.com/maps/place/Via+Regina+Margherita,+46,+95038+Santa+Maria+di+Licodia+CT/@37.6175802,14.8881081,20z/data=!4m6!3m5!1s0x13115180ec5b4cbf:0x11ec0a25356564b0!8m2!3d37.617611!4d14.8882705!16s%2Fg%2F11c5lm9z6y?entry=ttu&g_ep=EgoyMDI1MDgyNS4wIKXMDSoASAFQAw%3D%3D';
                  link.target = '_blank';
                  link.click();
